...
predicted_label = keras.utils.to_categorical(predicted_label, num_classes)
...
print(confusion_matrix(np.argmax(y_test, axis = 1).reshape((y_test.shape[0], 1)), np.argmax(predicted_label, axis = 1).reshape((predicted_label.shape[0], 1))))
